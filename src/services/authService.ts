...
// const AppError = require('../error/AppError.ts');
// const { sendPasswordResetEmail } = require('./emailService.ts');
...
//   async login(data: AuthLoginRequestDTO): Promise<AuthLoginResponseDTO> {
